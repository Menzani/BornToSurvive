...
class CreateRow implements CheckedSQLDatabaseCallable<Integer> {
    private final PreparedStatement preparedStatement;
    private final UUID playerId;

    CreateRow(PreparedStatement preparedStatement, UUID playerId) {
    ...
    public String getErrorMessage() {
        return "Could not create database row." + System.lineSeparator() + "context: " + toString();
    }
}
